...
public:
  ...
  LGFX(void) {
    ...
    // Bus configuration
    {
      ...
      cfg.freq_write = 14000000;  // Pixel clock frequency
    ...
    // Touch configuration
    {
      ...
      cfg.pin_int = GPIO_NUM_18;  // Interrupt pin
      cfg.bus_shared = false;    // Separate I2C bus for touch
      ...
      cfg.freq = 400000;
      cfg.i2c_addr = 0x14;  // Address of GT911 (verify this: 0x14 or 0x5D)
